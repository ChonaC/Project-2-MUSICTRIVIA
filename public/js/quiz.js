...
//const songRoutes = require('../../routes/api/song-routes');
//router.use('../../models/songs', songRoutes);
...
async function quizEnd() {
  ...
  for (var i = 0; i < quizAnswers.length; i++) {
    ...
    //addbutton.setAttribute("class", "choice");
    //addbutton.setAttribute("value", i);
    //addbutton.classList.add("btn", "btn-primary");
    //addbutton.textContent = "Add to saved songs";

    linkEl.append(imageEl, pEl);
    //addEle.append(linkEl, addbutton);
